    ...
    const response = await fetch("https://ai.gateway.lovable.dev/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: "system",
            content: `You are a compassionate and professional AI mental health companion. Your role is to:
...
- In crisis situations, encourage contacting professional help
